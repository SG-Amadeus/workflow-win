/*
  AsyncCore: ASIO win_iocp_socket_recvfrom_op, non-template.
*/

#ifndef _ASYNC_OP_RECVFROM_OP_H_
#define _ASYNC_OP_RECVFROM_OP_H_
...
class recvfrom_op : public win_iocp_operation
{
public:
	op_pools *pools_;
	handler_work work_;
	...
	recvfrom_op() : win_iocp_operation(&recvfrom_op::do_complete),
...
#endif /* _ASYNC_OP_RECVFROM_OP_H_ */

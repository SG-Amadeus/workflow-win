/*
  AsyncCore: vector read operation for random_access_handle.
*/

#ifndef _ASYNC_OP_HANDLE_READV_OP_H_
#define _ASYNC_OP_HANDLE_READV_OP_H_
...
class handle_readv_op : public win_iocp_operation
{
public:
	op_pools *pools_;
	handler_work work_;
	...
	handle_readv_op()
		: win_iocp_operation(&handle_readv_op::do_complete),
...
#endif /* _ASYNC_OP_HANDLE_READV_OP_H_ */
